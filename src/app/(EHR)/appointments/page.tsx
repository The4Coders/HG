        ...
        <div className="h-full bg-white w-full p-4">
                  ...
                  <aside className="flex flex-row gap-x-3">
                    <Link href="#">
                      <div className="w-60 h-32 cursor-pointer border-2 shadow-md bg-[#2E8B57] text-white rounded-lg flex flex-col p-2">
                        ...
                        <p className="ms-3 my-2 font-bold ">
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-col space-y-2 mt-2">
                  ...
                  <button
                    onClick={() =>
                      toast.success(
                        "Your Complete Medical Histroy has been sent to your email!"
                      )
                    }
              ...
              {previousMeetings.map((meeting) => (
                <li key={meeting.id} className="mb-4 text-lg">
                  <div className="p-4 rounded-lg space-y-4">
                    ...
                    <p>
                      <strong>Doctor:</strong> {meeting.doctor}
                    </p>
                    <p>
                      <strong>Summary:</strong> {meeting.summary}
                    </p>
                    <p className="mt-2">
                      <strong>Diagnosis:</strong> {meeting.diagnosis}
                    </p>
                    <p className="mt-2">
                      <strong>Prescription:</strong> {meeting.prescription}
                    </p>
                  </div>
                </li>
              ))}
          ...
          <div className="mt-8 bg-accent p-4 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg">
                <strong>Specialty:</strong> General Practitioner
              </p>
              <p className="text-lg">
