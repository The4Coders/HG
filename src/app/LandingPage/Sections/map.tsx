...
const Map = () => {
  ...
  return (
    <MapContainer center={userLocation || [9.082, 8.6753]} zoom={13} className="w-full h-full px-4">
      <TileLayer
        url={`https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&callback=initMap`}
