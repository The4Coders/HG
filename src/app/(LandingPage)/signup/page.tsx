      ...
      <div className="bg-[#65898C] w-full h-auto md:h-[584px] md:w-[820px] rounded-[20px] shadow-xl mx-auto flex flex-col md:flex-row border-[2px] border-black border-t-0 border-opacity-15">
          <div className="bg-[#063B3F] flex-1 rounded-t-[20px] md:rounded-tl-[20px] md:rounded-bl-[20px] md:rounded-r-[160px] relative flex justify-center items-center p-8">
            <div className="text-white text-center flex flex-col items-center">
              ...
              <Link href="/signin">
                <button className="rounded-[8px] text-white border border-white py-2 px-8 mt-4 md:mt-8 font-[600] uppercase moving-wave-button">
                  Sign In
                </button>
              </Link>
            </div>
          ...
          <div className="bg-white flex-1 rounded-b-[20px] md:rounded-bl-none md:rounded-r-[20px] p-8 pt-8 md:pt-20">
              ...
              <form id="signup-form" onSubmit={handleSubmit}>
                <div className="flex items-center flex-col">
                  <input
                    ...
                    required
                    placeholder="Email"
                    className="border border-gray-300 bg-[#eeeeee] rounded-[8px] py-2 px-4 focus:outline-none focus:border-[#063b3f] w-full max-w-xs"
                  />
                  <input
                    type="password"
                    name="password"
                    ...
                    className="border border-gray-300 bg-[#eeeeee] rounded-[8px] py-2 px-4 mt-4 focus:outline-none focus:border-[#063b3f] w-full max-w-xs"
                  />
                  <input
                    type="password"
                ...
                <div className="text-center">
                  ...
                  <button
                    className="bg-[#063b3f] text-white py-3 px-8 md:px-14 rounded-[8px] mt-4 uppercase w-full max-w-xs moving-wave-button"
                    type="submit"
                  >
                    Sign Up
                  </button>
